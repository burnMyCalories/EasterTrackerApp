	...
	<div class="layui-layout layui-layout-admin">
		...
		<div class="layui-header header">
			<div class="layui-main">
				<a href="#" class="logo">Admin Home</a>
<!--				&lt;!&ndash; 搜索 &ndash;&gt;-->
...
<!--			    </div>-->
			    ...
			    <ul class="layui-nav top_menu">
			    	<li class="layui-nav-item showNotice" id="showNotice" pc>
						<a href="javascript:;"><i class="iconfont icon-gonggao"></i><cite>Announcements</cite></a>
					</li>
...
<!--					</li>-->
					<li class="layui-nav-item" pc>
						<a href="javascript:;">
							...
							<cite><%=request.getAttribute("userName")%></cite>
						</a>
						<dl class="layui-nav-child">
							<dd><a href="javascript:;" data-url="page/user/userInfo.html"><i class="iconfont icon-zhanghu" data-icon="icon-zhanghu"></i><cite>Personal Info</cite></a></dd>
							<dd><a href="javascript:;" data-url="page/user/changePwd.html"><i class="iconfont icon-shezhi1" data-icon="icon-shezhi1"></i><cite>Change Password</cite></a></dd>
							<dd><a href="/test/login.html"><i class="iconfont icon-loginout"></i><cite>Logout</cite></a></dd>
						</dl>
					</li>
				</ul>
			</div>
		...
		<div class="layui-side layui-bg-black">
			<div class="user-photo">
				<a class="img" title="My photo" ><img src="images/face.jpg"></a>
				<p>Welcome Login!
		...
		<div class="layui-body layui-form">
			<div class="layui-tab marg0" lay-filter="bodyTab">
				<ul class="layui-tab-title top_tab">
					<li class="layui-this" lay-id=""><i class="iconfont icon-computer"></i> <cite>Admin Home Page</cite></li>
				</ul>
