...
<!--                                    <input id="login-username" type="text" name="userName" required data-msg="Please input username" placeholder="username" class="input-material">-->
<!--                                </div>-->
<!--                                <div class="form-group">-->
<!--                                    <input id="login-password" type="password" name="passWord" required data-msg="Please input password" placeholder="password" class="input-material">-->
<!--                                </div>-->
                                <div class="infotext">Incorrect Username or Password!</div>
                                <br/>
                                <button id="login" type="submit" class="btn btn-primary">ReLogin</button>
...
<!--                                    </div>-->
                            ...
                            <br />
<!--                            <small>No account?</small><a href="register.jsp" class="signup">&nbsp;Register</a>-->
                        </div>
                    </div>
                </div>
            </div>
